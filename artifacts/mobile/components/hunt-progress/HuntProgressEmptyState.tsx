/**
 * HuntProgressEmptyState — Reusable empty/error state for Hunt Progress sections.
 */
...
export default function HuntProgressEmptyState({ icon, title, body, actionLabel, onAction }: Props) {
...
const styles = StyleSheet.create({
  ...
  body: {
    ...
    lineHeight: fontSize.base * 1.55, textAlign: 'center',
  },
  button: {
    marginTop: spacing[2], paddingHorizontal: spacing[6],
    paddingVertical: spacing[3], borderRadius: radius.xl,
  },
  buttonLabel: { fontFamily: fontFamily.semiBold, fontSize: fontSize.sm, color: '#fff' },
});
